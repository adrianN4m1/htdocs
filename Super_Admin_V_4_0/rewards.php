            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="row gy-4" style="margin-bottom: 20px;padding-top: 0px;margin-top: -24px;">
                        <div class="col">
                            <div class="shadow card"><a class="btn btn-link text-start card-header fw-bold" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapse-1" href="#collapse-1" role="button" style="font-size: 20px;">Available Rewards</a>
                                <div class="collapse" id="collapse-1">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col d-xxl-flex justify-content-xxl-end"><button class="btn btn-outline-primary text-truncate text-end float-none float-sm-none add-another-btn" data-bss-hover-animate="pulse" type="button" style="position: relative;" data-bs-target="#edit-award-modal" data-bs-toggle="modal">Add Reward Item<i class="fas fa-hat-wizard edit-icon"></i></button></div>
                                        </div>
