                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                        aria-expanded="false" data-bs-toggle="dropdown" href="#"><span
                                            class="d-none d-lg-inline me-2 text-gray-600 small">Sev
                                            Constantino</span><img class="border rounded-circle img-profile"
        ...
        <div class="modal-content">
            <form action="php/inventory/inventory_add.php" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <input type="file" id="prod_image" name="prod_image" accept=".jpg, .jpeg, .png" style="padding-bottom: 10px;margin-bottom: 4px;width: 100%;padding-top: 4px;">
                    <div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Barcode</td>
                                        <td>
                                            <input type="text" style="padding-top: 4px;padding-right: 8px;padding-bottom: 4px;padding-left: 8px;font-size: 12px;width: 100%;color: var(--bs-gray-900);border-radius: 4px;border: 1px solid var(--bs-table-active-color);" placeholder="0x153" disabled="">
                                            <p class="text-end" style="color: var(--bs-danger);font-size: 8px;margin-bottom: 0px;">Edit unavailable</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Product</td>
                                        <td><input id="product_name" name="product_name" type="text" style="padding-top: 4px;padding-right: 8px;padding-bottom: 4px;padding-left: 8px;font-size: 12px;width: 100%;color: var(--bs-gray-900);border-radius: 4px;border: 1px solid var(--bs-table-active-color);" placeholder="test"></td>
                                    </tr>
                                    <tr>
                                        <td>Type</td>
                                        <td><input id="product_type" name="product_type" type="text" style="padding-top: 4px;padding-right: 8px;padding-bottom: 4px;padding-left: 8px;font-size: 12px;width: 100%;color: var(--bs-gray-900);border-radius: 4px;border: 1px solid var(--bs-table-active-color);" value="Diesel"></td>
                                    </tr>
                                    <tr>
                                        <td>Price</td>
                                        <td><input id="price" name="price" type="text" style="padding-top: 4px;padding-right: 8px;padding-bottom: 4px;padding-left: 8px;font-size: 12px;width: 100%;color: var(--bs-gray-900);border-radius: 4px;border: 1px solid var(--bs-table-active-color);" value="68.09"></td>
                                    </tr>
                                    <tr>
                                    <tr>
                                        <td>Base Price</td>
                                        <td><input id="price_base" name="price_base" type="text" style="padding-top: 4px;padding-right: 8px;padding-bottom: 4px;padding-left: 8px;font-size: 12px;width: 100%;color: var(--bs-gray-900);border-radius: 4px;border: 1px solid var(--bs-table-active-color);" value="40.9"></td>
                                    </tr>
                                    <tr>
                                        <td>Name of Supplier</td>
                                        <td>
                                            <select id="supplier_id" name="supplier_id" style="color: var(--bs-gray);border-radius: 2px;font-size: 12px;padding: 4px;padding-right: 24px;width: 100%;border-color: var(--bs-gray);">
                                    ...
                                    <tr>
                                        <td>Expiration</td>
                                        <td><input id="expiration_date" name="expiration_date" type="text" style="padding-top: 4px;padding-right: 8px;padding-bottom: 4px;padding-left: 8px;font-size: 12px;width: 100%;color: var(--bs-gray-900);border-radius: 4px;border: 1px solid var(--bs-table-active-color);" value="08/10/2024"></td>
                                    </tr>
                                    <tr>
                                        <td>In Stock</td>
                                        <td><input id="inv_stock" name="inv_stock" type="text" style="padding-top: 4px;padding-right: 8px;padding-bottom: 4px;padding-left: 8px;font-size: 12px;width: 100%;color: var(--bs-gray-900);border-radius: 4px;border: 1px solid var(--bs-table-active-color);" value="24"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="modal-footer d-xxl-flex justify-content-between justify-content-xxl-end">
                    <button class="btn btn-primary" type="submit" style="background: var(--bs-btn-disabled-border-color);border-style: none;"><i class="fas fa-plus"></i>&nbsp;Add Item</button>
                </div>
            </form>
        </div>
    </div>
