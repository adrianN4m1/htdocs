...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="assets/css/-Login-form-Page-BS4--Login-form-Page-BS4.css"
    />
          ...
          <ul class="navbar-nav text-light" id="accordionSidebar">
            ...
            <li class="nav-item">
              <a class="nav-link" href="inventory.php"
                ><i class="fas fa-database"></i><span>Inventory</span></a
              ><a class="nav-link" href="suppliers.php"
                ><i class="fas fa-truck"></i><span>Suppliers</span></a
              ><a class="nav-link" href="branches.php"
                ><i class="fas fa-warehouse"></i><span>Branches</span></a
              >
            </li>
            <li class="nav-item"></li>
            <li class="nav-item">
              <a class="nav-link" href="branch_owners.php"
                ><i class="fas fa-user-tie"></i><span>Branch Admins</span></a
              ><a class="nav-link" href="rewards.php"
                ><i class="fas fa-award"></i><span>Rewards</span></a
              >
            </li>
          </ul>
        ...
        <div id="content">
          ...
          <div class="container">
            <div class="row">
              ...
              <div
                class="col-md-6 float-end d-xxl-flex justify-content-xxl-end"
              >
                <a
                  class="btn btn-success d-xxl-flex justify-content-xxl-end btn-icon-split"
                  role="button"
                  style="
                ...
                <div class="card shadow mb-4">
                  ...
                  >
                    <div class="d-flex">
                      ...
                      <h6
                        class="text-primary fw-bold m-0"
                        style="color: rgb(255, 164, 113)"
                      >
                        Transaction
                      </h6>
                      <h6
                        class="text-primary fw-bold m-0"
                        style="margin-left: 36px; padding-left: 18px"
                      >
                        ( Weekly )
                      </h6>
                    </div>
                    <div class="dropdown no-arrow">
                      ...
                      <div
                        class="dropdown-menu dropdown-menu-end shadow animated--fa #de-in"
                      >
                  ...
                  <div class="card-body">
                    ...
                    >
                      <canvas
                        data-bss-chart='{"type":"bar","data":{"labels":["100","70","300","230","140","430","100","100","200","300","200","100","100","70","300","230","140","430","100","100","200","300","200","100"],"datasets":[{"label":"Gross Profit","backgroundColor":"#1cc88a","borderColor":"#ffffff","data":["100","70","300","230","140","430","100","100","200","300","200","100"]},{"label":"Net Profit","backgroundColor":"#ffa471","borderColor":"#ffffff","data":["50","20","81","100","70","300","50","50","100","150","100","40"]}]},"options":{"maintainAspectRatio":true,"legend":{"display":true,"labels":{"fontStyle":"normal"}},"title":{"fontStyle":"bold"},"scales":{"xAxes":[{"ticks":{"fontStyle":"normal"}}],"yAxes":[{"ticks":{"fontStyle":"normal"}}]}}}'
                      ></canvas>
                    </div>
                  </div>
                </div>
              ...
              <div class="col col-3">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body" style="display: grid">
                      <div style="display: inline-flex">
                        ...
                        <p
                          class="text-dark d-xxl-flex align-items-xxl-center m-0"
                ...
                <div class="card shadow border-start-warning py-2">
                  <div class="card-body" style="padding-top: 5px">
                    ...
                    >
                      <canvas
                        data-bss-chart='{"type":"pie","data":{"labels":["Revenue","Transactions"],"datasets":[{"label":"Revenue","backgroundColor":["rgb(28,200,138)","rgb(255,164,113)"],"borderColor":["#ffffff","#ffffff"],"data":["50","50"]}]},"options":{"maintainAspectRatio":true,"legend":{"display":true,"labels":{"fontStyle":"normal"}},"title":{"fontStyle":"bold"}}}'
                      ></canvas>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col">
                <div class="card shadow">
                  ...
                  <div class="card-body">
                    <div
                      style="overflow: scroll; overflow-x: hidden; height: 40vh"
                    >
                      <div
              ...
              <div class="col col-md-8">
                ...
                <div
                  style="--bs-success: #1cc88a; --bs-success-rgb: 28, 200, 138"
                >
                  <canvas
              ...
              <div class="col">
                <div class="card shadow">
                  <div class="card-header py-3">
                    <div>
                      <p
                        class="text-primary d-inline m-0 fw-bold"
