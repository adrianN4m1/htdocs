...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="width: 100%;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="inventory.html"><i class="fas fa-database"></i><span>Products</span></a><a class="nav-link active" href="branch_information.html"><i class="fas fa-info"></i><span>&nbsp;Branch Info</span></a></li>
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="row gy-4" style="padding-bottom: 20px;margin-top: -6px;">
                        <div class="col">
                            <div class="shadow card"><a class="btn btn-link text-start card-header fw-bold" data-bs-toggle="collapse" aria-expanded="true" aria-controls="collapse-3" href="#collapse-3" role="button" style="font-size: 20px;">Users</a>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="edit-branch-modal" style="border-style: solid;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit Branch</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div style="padding-bottom: 0px;margin-bottom: 13px;"><input type="text" id="username-1" placeholder="ID" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;" disabled="">
                        <hr>
                    </div>
                    <div style="padding-bottom: 0px;margin-bottom: 14px;"></div>
                    <div style="padding-bottom: 0px;margin-bottom: 14px;"></div>
                    <div style="padding-bottom: 0px;margin-bottom: 14px;">
                        <p style="margin-bottom: -3px;font-size: 10px;">Branch Name</p><input type="text" id="username-10" placeholder="Tandang Sora Branch" name="mobile_number" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                    </div>
                    <div style="padding-bottom: 0px;margin-bottom: 14px;"></div>
                    <div style="padding-bottom: 0px;margin-bottom: 14px;"></div>
                    <div style="padding-bottom: 0px;margin-bottom: 14px;">
                        <p style="margin-bottom: -3px;font-size: 10px;">Full Address (specify as much as possible)</p><textarea style="width: 100%;height: 81px;"></textarea>
                    </div>
                </div>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="add-user-modal" style="border-style: solid;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add User</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 13px;">
                                <p class="text-start" style="color: var(--bs-gray);font-size: 12px;margin-bottom: 0px;">User ID</p><input type="text" id="username-2" placeholder="ID" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;" disabled="">
                                <p class="text-end" style="color: var(--bs-blue);font-size: 12px;">Auto-generated text</p>
                            </div>
                        </div>
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 13px;">
                                <p class="text-start" style="color: var(--bs-gray);font-size: 12px;margin-bottom: 0px;">Branch</p><input type="text" id="username-4" placeholder="Tandang Sora" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;" disabled="">
                                <p class="text-end" style="color: var(--bs-blue);font-size: 12px;">Auto-generated text</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 14px;">
                                <p style="margin-bottom: -3px;font-size: 10px;">Given name</p><input type="text" id="username-3" placeholder="Sev" name="mobile_number" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 14px;">
                                <p style="margin-bottom: -3px;font-size: 10px;">Last name</p><input type="text" id="username-5" placeholder="Constantino" name="mobile_number" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 14px;">
                                <p style="margin-bottom: -3px;font-size: 10px;">Mobile number</p><input type="text" id="username-6" placeholder="09876543210" name="mobile_number" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 14px;">
                                <p style="margin-bottom: -3px;font-size: 10px;">email</p><input type="email" style="width: 100%;color: var(--bs-gray);">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="edit-user-modal" style="border-style: solid;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit User</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 13px;">
                                <p class="text-start" style="color: var(--bs-gray);font-size: 12px;margin-bottom: 0px;">User ID</p><input type="text" id="username-7" placeholder="ID" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;" disabled="">
                                <p class="text-end" style="color: var(--bs-blue);font-size: 12px;">Auto-generated text</p>
                            </div>
                        </div>
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 13px;">
                                <p class="text-start" style="color: var(--bs-gray);font-size: 12px;margin-bottom: 0px;">Branch</p><input type="text" id="username-8" placeholder="Tandang Sora" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;" disabled="">
                                <p class="text-end" style="color: var(--bs-blue);font-size: 12px;">Auto-generated text</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 14px;">
                                <p style="margin-bottom: -3px;font-size: 10px;">Given name</p><input type="text" id="username-9" placeholder="Sev" name="mobile_number" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 14px;">
                                <p style="margin-bottom: -3px;font-size: 10px;">Last name</p><input type="text" id="username-11" placeholder="Constantino" name="mobile_number" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div style="padding-bottom: 0px;margin-bottom: 14px;">
                                <p style="margin-bottom: -3px;font-size: 10px;">Mobile number</p><input type="text" id="username-12" placeholder="09876543210" name="mobile_number" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
