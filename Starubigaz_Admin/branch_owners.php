...
<body id="page-top">
                    ...
                    <div class="card shadow" style="width: 100%;">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col" style="text-align: right;"><button class="btn btn-outline-primary text-truncate text-end float-none float-sm-none add-another-btn" data-bss-hover-animate="pulse" type="button" style="position: relative;" data-bs-target="#register-modal" data-bs-toggle="modal">Add new Admin<i class="fas fa-user-astronaut edit-icon"></i></button></div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add new Admin</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col"><select style="color: var(--bs-gray-dark);border-radius: 2px;font-size: 16px;padding: 4px;padding-right: 24px;border-color: var(--bs-gray);">
                    ...
                    <div style="padding-bottom: 0px;margin-bottom: 14px;">
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col">
                                <p style="margin-bottom: -3px;font-size: 10px;">Given name</p><input type="text" id="username-2" placeholder="Sev Christian" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                            <div class="col">
                                <p style="margin-bottom: -3px;font-size: 10px;">Last name</p><input type="text" id="username-7" placeholder="Catalan" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                <p style="margin-bottom: -3px;font-size: 10px;">Mobile number</p><input type="text" id="username-3" placeholder="09876543210" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="edit-modal" style="border-style: solid;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit Admin</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                    ...
                    <div style="padding-bottom: 0px;margin-bottom: 14px;">
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col">
                                <p style="margin-bottom: -3px;font-size: 10px;">Given name</p><input type="text" id="username-4" placeholder="Sev Christian" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                            <div class="col">
                                <p style="margin-bottom: -3px;font-size: 10px;">Last name</p><input type="text" id="username-5" placeholder="Catalan" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                <p style="margin-bottom: -3px;font-size: 10px;">Mobile number</p><input type="text" id="username-6" placeholder="09876543210" name="username" style="width: 100%;--bs-primary: #4e73df;--bs-primary-rgb: 78,115,223;">
                            </div>
                        </div>
                    </div>
                    <div style="padding-bottom: 0px;margin-bottom: 14px;"></div>
