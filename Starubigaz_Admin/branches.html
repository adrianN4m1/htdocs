            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" style="margin-bottom: 18px;">
                        ...
                        <div class="col-md-6 text-end d-xxl-flex justify-content-xxl-end"><button class="btn btn-outline-primary text-truncate text-end float-none float-sm-none add-another-btn" data-bss-hover-animate="pulse" type="button" style="width: 135px;position: relative;" data-bs-target="#branch-creation-modal" data-bs-toggle="modal">Add Branch<i class="fas fa-gas-pump edit-icon"></i></button></div>
                    </div>
                </div>
                <hr>
                <div class="container">
                    <div class="row gy-4">
                        <div class="col-md-3"><a href="branch_information.html">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            ...
                                            <div class="col me-2" style="text-align: right;">
                                                <div class="text-dark fw-bold h5 mb-0"><span>Tandang Sora Branch</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow-lg border-start-primary py-2" data-bss-hover-animate="pulse">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col-auto"><i class="fas fa-gas-pump fa-2x text-gray-300"></i></div>
                                            <div class="col me-2" style="text-align: right;">
                                                <div class="text-dark fw-bold h5 mb-0"><span>Mapagkaling Branch</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow-lg border-start-primary py-2" data-bss-hover-animate="pulse">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col-auto"><i class="fas fa-gas-pump fa-2x text-gray-300"></i></div>
                                            <div class="col me-2" style="text-align: right;">
                                                <div class="text-dark fw-bold h5 mb-0"><span>E. Rodriguez Branch</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow-lg border-start-primary py-2" data-bss-hover-animate="pulse">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col-auto"><i class="fas fa-gas-pump fa-2x text-gray-300"></i></div>
                                            <div class="col me-2" style="text-align: right;">
                                                <div class="text-dark fw-bold h5 mb-0"><span>San Marcelino Branch</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Add a new Branch</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
