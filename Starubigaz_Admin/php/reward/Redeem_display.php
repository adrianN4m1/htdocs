...
$sql = "SELECT DISTINCT t.transaction_date, t.transaction_id, o.order_id, o.order_date, t.points, rc.reward_id, u.username, r.reward_name
        FROM transactions t
        ...
        WHERE bc.branch_id = ? AND t.transaction_type='Redeem'
